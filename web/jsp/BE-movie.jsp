                    ...
                    <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                        <form class="form-horizontal">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-lg-2 control-label" for="districtId">地区 </label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control col-md-6" name="districtId" id="districtId" autocomplete="off" data-provide="typeahead" data-items="4" />
