...
<ul class="leftContent fl">
    ...
    <li><a href="${pageContext.request.contextPath}/user/changePasswordUI.do"  class="<s:property value="actionName=='changePasswordUI'||'updatePwSuccess'?'activeLi':''"/> ">修改密码</a></li>
